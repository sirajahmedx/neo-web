...
export function Header() {
  ...
  return (
    <header className="sticky top-0 left-0 right-0 z-10 flex flex-col gap-2 items-center justify-between p-4 bg-background border-b border-muted max-w-6xl mx-auto mb-4">
